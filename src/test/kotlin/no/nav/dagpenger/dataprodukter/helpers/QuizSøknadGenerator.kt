package no.nav.dagpenger.dataprodukter.helpers
...
fun Seksjoner.seksjon(generator: Map<String, Any>) = this.also { it.add(mapOf("fakta" to listOf(generator))) }

fun generator(
    beskrivendeId: String,
    vararg faktum: Map<String, Any>,
) = mapOf(
