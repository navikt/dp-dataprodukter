...
internal class OppgaveRiverTest {
    ...
    @Test
    fun `Kan videreformidle tilstandsendring på oppgave til statistikk`() {
    ...
    @Test
    fun `Kan videreformidle tilstandsendring på oppgave uten saksbehandler og beslutter`() {
    ...
    private val oppgaveTilStatistikk =
        """{
  "@event_name": "oppgave_til_statistikk_v6",
  "oppgave": {
